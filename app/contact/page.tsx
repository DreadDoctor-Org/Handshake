      ...
      <main className="flex-1">
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-1 space-y-6">
              ...
              <Card className="border-0 shadow-lg bg-white/95 backdrop-blur p-6 space-y-3">
                <h3 className="text-xl font-bold text-[#001f23]">Email</h3>
                <p className="text-[#001f23]/70">For all inquiries and support:</p>
                <button
                  onClick={() => {
                  ...
                  className="text-lg font-semibold text-[#59E4A0] hover:text-[#23DAC2] transition break-all"
                >
                  {ADMIN_EMAIL}
                </button>
              </Card>
              ...
              {/* Support */}
              <Card className="border-0 shadow-lg bg-white/95 backdrop-blur p-6 space-y-3">
                <h3 className="text-xl font-bold text-[#001f23]">Support For</h3>
                <ul className="space-y-2 text-sm text-[#001f23]/70">
            ...
            {/* Contact Form */}
            <Card className="md:col-span-2 border-0 shadow-lg bg-white/95 backdrop-blur p-6 md:p-8">
              <h2 className="text-2xl font-bold text-[#001f23] mb-6">Send us a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-[#001f23] mb-1">
                    Full Name
                  </label>
                  <Input
                    id="name"
                    ...
                    className="bg-[#001f23]/5 border-[#001f23]/20"
                  />
                </div>

                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-[#001f23] mb-1">
                    Email Address
                  </label>
                  <Input
                    id="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-[#001f23] mb-1">
                    Subject
                  </label>
                  <Input
                    id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-[#001f23] mb-1">
                    Message
                  </label>
                  <textarea
                    id="message"
                    ...
                    onChange={handleChange}
                    disabled={isSubmitting}
                    className="w-full px-3 py-2 border border-[#001f23]/20 rounded-md bg-[#001f23]/5 text-[#001f23] placeholder-[#001f23]/50 focus:outline-none focus:ring-2 focus:ring-[#59E4A0] text-sm"
                  />
                </div>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-r from-[#B8F663] to-[#59E4A0] p-8 md:p-12 space-y-4">
            <h3 className="text-xl font-bold text-[#001f23]">Response Time</h3>
            <p className="text-base text-[#001f23]">
