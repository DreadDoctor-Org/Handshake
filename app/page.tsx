      ...
      <header className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4">
        ...
        <nav className="flex items-center gap-2 md:gap-4">
          <Link href="/auth/login">
            <Button variant="ghost" className="text-xs md:text-sm text-[#001f23] hover:bg-white/20 px-2 md:px-4">
              Sign In
            </Button>
          </Link>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-6 md:py-12">
        <div className="w-full max-w-4xl space-y-8 md:space-y-12">
          <div className="text-center space-y-3 md:space-y-6">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-[#001f23] text-balance leading-tight">
          ...
          <div className="bg-white/95 backdrop-blur rounded-2xl p-4 md:p-8 shadow-lg">
            <h3 className="text-xl md:text-2xl font-bold text-[#001f23] mb-6 md:mb-8">How It Works</h3>
