...
export const metadata: Metadata = {
  ...
  description: 'Register and complete cryptocurrency payment to access verified handshake accounts ready to task in third-world countries. Fast, secure, and decentralized.',
  generator: 'v0.app',
  icons: {
