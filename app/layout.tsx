...
export const metadata: Metadata = {
  ...
  description: 'Register and complete payment to access verified Handshake accounts ready to task globally. Fast, secure, and professional.',
  ...
  other: {
    'google-adsense-account': 'ca-pub-4003129432428812',
  },
}
  ...
  return (
    <html lang="en">
      <body className="font-sans antialiased">
        ...
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4003129432428812"
